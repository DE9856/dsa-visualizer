...
import { optimalBst } from "./optimalBst";

/**
 * The seven problems the DP view knows, grouped by what the table is indexed by
 ...
 */
export const DP_PROBLEMS = [lcs, editDistance, knapsack, coinChange, lis, matrixChain, optimalBst];
